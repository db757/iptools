...
func TestCIDRBoundariesHandler(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "IPv6 Sextillions (bits < 80)",
			cidr:      "2001:db8::/75",
			wantShort: "2001:db8::-2001:db8::1f:ffff:ffff:ffff",
			wantLong:  "2001:db8::/75 (~Sextillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::1f:ffff:ffff:ffff",
		},
		{
			name:      "IPv6 Septillions (bits < 90)",
			cidr:      "2001:db8::/85",
			wantShort: "2001:db8::-2001:db8::7ff:ffff:ffff",
			wantLong:  "2001:db8::/85 (~Septillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::7ff:ffff:ffff",
		},
		{
			name:      "IPv6 Octillions (bits < 100)",
			cidr:      "2001:db8::/95",
			wantShort: "2001:db8::-2001:db8::1:ffff:ffff",
			wantLong:  "2001:db8::/95 (~Octillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::1:ffff:ffff",
		},
		{
			name:      "IPv6 Nonillions (bits < 110)",
			cidr:      "2001:db8::/105",
			wantShort: "2001:db8::-2001:db8::7f:ffff",
			wantLong:  "2001:db8::/105 (~Nonillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::7f:ffff",
		},
		{
			name:      "IPv6 Decillions (bits < 120)",
			cidr:      "2001:db8::/115",
			wantShort: "2001:db8::-2001:db8::1fff",
			wantLong:  "2001:db8::/115 (~Decillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::1fff",
		},
		{
			name:      "IPv6 Undecillions (bits <= 128)",
			cidr:      "2001:db8::/125",
			wantShort: "2001:db8::-2001:db8::7",
			wantLong:  "2001:db8::/125 (~Undecillions addresses):\nfrom: 2001:db8::\nto: 2001:db8::7",
		},
		{
			name:    "Invalid CIDR",
			cidr:    "invalid-cidr",
