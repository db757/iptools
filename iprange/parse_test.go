...
func TestParseRanges(t *testing.T) {
	tests := map[string]struct {
		...
		"multiple ranges": {
			input: "2001:db8::0 192.0.2.0-192.0.2.10 2001:db8::0/126 192.0.2.0/255.255.255.0 ::1234:5678 ::",
			wantRanges: []Range{
				prepareRange("2001:db8::0", "2001:db8::0"),
				prepareRange("192.0.2.0", "192.0.2.10"),
				prepareRange("2001:db8::0", "2001:db8::3"),
				prepareRange("192.0.2.0", "192.0.2.255"),
				prepareRange("::1234:5678", "::1234:5678"),
				prepareRange("::", "::"),
			},
		},
		...
		"single invalid syntax > 128b ipv6": {
			input:   "777c:ab4b:85f0:1614:49e5:d29b:aa7b:cc90:beef",
			wantErr: true,
		},
...
func TestParseRange(t *testing.T) {
	tests := map[string]struct {
		...
		"v6 CIDR: /64": {
			input:     "2001:db8::/64",
			wantRange: prepareRange("2001:db8::0", "2001:db8::ffff:ffff:ffff:ffff"),
		},
		"v6 CIDR: /126": {
			input:     "2001:db8::/126",
			wantRange: prepareRange("2001:db8::0", "2001:db8::3"),
		},
		"v6 CIDR: /127": {
			input:     "2001:db8::/127",
