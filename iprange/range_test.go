...
func TestV4RangeString(t *testing.T) {
...
func TestV4RangeFamily(t *testing.T) {
	tests := map[string]struct {
		input string
	}{
		"IP":    {input: "192.0.2.0"},
...
func TestV4RangeContains(t *testing.T) {
	tests := map[string]struct {
		input    string
		ip       string
		wantFail bool
...
func TestV6RangeString(t *testing.T) {
	tests := map[string]struct {
		input      string
		wantString string
	}{
...
func TestV6RangeFamily(t *testing.T) {
	tests := map[string]struct {
		input string
	}{
		"IP":    {input: "2001:db8::"},
...
func TestV6RangeContains(t *testing.T) {
	tests := map[string]struct {
		input    string
		ip       string
		wantFail bool
...
func TestIP6RangeSize(t *testing.T) {
	tests := map[string]struct {
		input    string
		wantSize *big.Int
	}{
...
func TestIP4RangeSize(t *testing.T) {
	tests := map[string]struct {
		input    string
		wantSize *big.Int
	}{
